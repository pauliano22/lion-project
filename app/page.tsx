...
function ProtectionCard({ title, description, examples }: ProtectionCardProps) {
  return (
    <div className="protection-card bg-gradient-to-br from-gray-900/50 to-black/50 backdrop-blur-sm border border-orange-500/20 rounded-2xl p-8 hover:border-orange-500/40 transition-all duration-500 group shadow-lg shadow-orange-500/5">
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    return () => {
      document.documentElement.classList.remove('content-ready');
      document.body.classList.remove('content-ready');
    };
  }, []);

  useEffect(() => {
    // Set up scroll animations after content loads
      ...
      <div className="loading-screen">
        <div className="loading-content">
          <div className="shield-container">
            <div className="shield-outer-ring">
              <div className="shield-inner-ring">
  ...
  // Main content
  return (
    <div className={`min-h-screen bg-black text-white ${showContent ? 'content-loaded' : 'content-hidden'}`}>
      {/* Navigation */}
      <header className="nav-header fixed top-0 left-0 right-0 z-50 bg-black/80 backdrop-blur-lg border-b border-orange-500/20">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          <div className="nav-logo flex items-center space-x-4">
            <div className="logo-circle w-12 h-12 bg-gradient-to-br from-red-500 to-red-600 rounded-full flex items-center justify-center">
              <Shield className="w-6 h-6 text-white" />
            </div>
            <span className="logo-text text-xl font-light text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-red-500 tracking-wider">
              Lion Project
            </span>
          </div>

          <nav className="nav-items hidden md:flex space-x-8">
            <button onClick={() => smoothScrollTo('protection')} className="nav-link text-gray-300 hover:text-orange-400 transition-colors font-light">
              Protection
            </button>
            <button onClick={() => smoothScrollTo('how-it-works')} className="nav-link text-gray-300 hover:text-orange-400 transition-colors font-light">
              How it Works
            </button>
            <button onClick={() => smoothScrollTo('products')} className="nav-link text-gray-300 hover:text-orange-400 transition-colors font-light">
              Products
            </button>
            <button onClick={() => smoothScrollTo('developers')} className="nav-link text-gray-300 hover:text-orange-400 transition-colors font-light">
              Developers
            </button>
          </nav>
          ...
          <button
            ...
            className="nav-cta bg-gradient-to-r from-orange-500 to-red-500 text-white px-6 py-3 rounded-xl font-light hover:from-orange-400 hover:to-red-400 transition-all duration-300 shadow-lg shadow-orange-500/25"
          >
            Try Demo
          </button>
        </div>
      ...
      {/* Hero Section */}
      <section className="hero-section min-h-screen flex items-center justify-center relative overflow-hidden pt-20 pb-20">
        {/* Background Image */}
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="hero-content text-center space-y-8 max-w-5xl mx-auto">
            <div className="hero-text space-y-6">
              <h1 className="hero-title text-4xl lg:text-6xl xl:text-7xl font-extralight leading-tight">
                See through <span className="hero-gradient text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-red-500 font-light">AI deception</span>
              </h1>
              <p className="hero-subtitle text-xl lg:text-2xl text-white font-light leading-relaxed mx-auto max-w-3xl">
            ...
            <div className="hero-buttons flex flex-wrap gap-4 justify-center">
              <button
                onClick={() => smoothScrollTo('demo')}
                className="hero-btn-primary bg-gradient-to-r from-orange-500 to-red-500 text-white px-8 py-4 rounded-xl font-light text-lg hover:from-orange-400 hover:to-red-400 transition-all duration-300 flex items-center shadow-lg shadow-orange-500/25"
              >
              ...
              <button
                ...
                className="hero-btn-secondary bg-black/30 border border-orange-500/50 text-orange-400 px-8 py-4 rounded-xl font-light text-lg hover:bg-orange-500/10 transition-all duration-300 flex items-center backdrop-blur-sm"
              >
            ...
            <div className="hero-platforms flex flex-col items-center space-y-4 pt-4">
              <span className="text-gray-300 font-light text-sm">Available on:</span>
              <div className="platform-icons flex space-x-4">
                <Monitor className="platform-icon w-6 h-6 text-gray-300 hover:text-orange-400 transition-colors" />
                <Apple className="platform-icon w-6 h-6 text-gray-300 hover:text-orange-400 transition-colors" />
                <Computer className="platform-icon w-6 h-6 text-gray-300 hover:text-orange-400 transition-colors" />
                <Smartphone className="platform-icon w-6 h-6 text-gray-300 hover:text-orange-400 transition-colors" />
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Protection Types */}
      <section id="protection" className="protection-section section-animate py-20">
        <div className="container mx-auto px-6">
          <div className="section-header text-center mb-16">
            <h2 className="section-title text-4xl lg:text-5xl font-extralight mb-6">
          ...
          <div className="protection-cards grid lg:grid-cols-2 gap-8 mb-20">
            <ProtectionCard
          ...
          <div className="features-grid grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={index}
                className="feature-card bg-gradient-to-br from-gray-900/30 to-black/30 backdrop-blur-sm border border-orange-500/10 rounded-2xl p-6 text-center hover:border-orange-500/30 transition-all duration-500"
              >
                <div className="feature-icon text-orange-400 mb-4 flex justify-center">
                  {feature.icon}
                </div>
                <h4 className="feature-title text-xl font-light text-orange-400 mb-3">
                  {feature.title}
                </h4>
                <p className="feature-desc text-gray-300 font-light">
                  {feature.desc}
                </p>
              </div>
            ))}
      ...
      <section id="how-it-works" className="how-it-works-section section-animate py-20 relative">
        <div className="container mx-auto px-6">
          <div className="section-header text-center mb-16">
            <h2 className="section-title text-4xl lg:text-5xl font-extralight mb-6">
            ...
            <p className="section-subtitle text-xl text-gray-300 font-light max-w-3xl mx-auto leading-relaxed">
              Competitors charge $13-$700/month for single tools. They can&apos;t touch our prices.
            </p>
          </div>

          <div className="pricing-card bg-gradient-to-br from-gray-900/50 to-black/50 backdrop-blur-sm border border-orange-500/20 rounded-3xl p-8 mb-16 shadow-lg shadow-orange-500/5">
            <h3 className="pricing-title text-3xl font-light text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-red-500 mb-12 text-center">
              Unmatched Pricing
            </h3>
            <div className="pricing-grid grid md:grid-cols-4 gap-6">
              <div className="price-item border border-red-500/30 rounded-2xl p-6 text-center bg-red-500/5">
              ...
              <div className="price-item border border-orange-500 rounded-2xl p-6 text-center bg-orange-500/5">
              ...
              <div className="price-item bg-green-900/20 border border-green-500/30 rounded-2xl p-6 text-center">
      ...
      {/* Products Section */}
      <section id="products" className="products-section section-animate py-20 bg-gradient-to-b from-transparent to-orange-500/5">
        <div className="container mx-auto px-6">
          <div className="section-header text-center mb-16">
            <h2 className="section-title text-4xl lg:text-5xl font-extralight mb-6">
            ...
            <p className="section-subtitle text-xl text-gray-300 font-light max-w-2xl mx-auto">
              Our Chrome extension and desktop apps are now live! Mobile app launching soon.
            </p>
          </div>

          <div className="products-grid grid lg:grid-cols-3 gap-8">
            {/* Desktop Guardian */}
            <div className="product-card bg-gradient-to-br from-gray-900/50 to-black/50 backdrop-blur-sm border border-orange-500/20 rounded-3xl p-8 hover:border-orange-500/40 transition-all duration-500 shadow-lg shadow-orange-500/5">
              ...
              <div className="download-links space-y-3">
                {[
                  {
            ...
            <div className="product-card coming-soon bg-gradient-to-br from-gray-900/50 to-black/50 backdrop-blur-sm border border-orange-500/20 rounded-3xl p-8 opacity-75 hover:opacity-90 transition-all duration-500 shadow-lg shadow-orange-500/5">
              <div className="h-48 bg-gradient-to-br from-orange-500/10 to-red-500/10 rounded-2xl overflow-hidden border border-orange-500/20 mb-6">
                <Image
          ...
          <div className="max-w-6xl mx-auto">
            <div className="section-header text-center mb-16">
              <div className="flex items-center justify-center mb-6">
                ...
                <h2 className="section-title text-4xl lg:text-5xl font-extralight">
                  For <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-red-500">Developers</span>
                </h2>
              </div>
              <p className="section-subtitle text-xl text-gray-300 font-light max-w-2xl mx-auto leading-relaxed">
                Integrate our powerful deepfake detection capabilities directly into your applications with our developer-friendly API.
              </p>
            </div>

            <div className="dev-cards grid lg:grid-cols-2 gap-8 mb-12">
              <div className="dev-card bg-gradient-to-br from-gray-900/50 to-black/50 backdrop-blur-sm border border-orange-500/20 rounded-2xl p-8 shadow-lg shadow-orange-500/5">
            ...
            <div className="code-examples bg-gradient-to-br from-gray-900/50 to-black/50 backdrop-blur-sm border border-orange-500/20 rounded-2xl p-8 mb-8 shadow-lg shadow-orange-500/5">
...
console.log(result.data);`}
            ...
            <div className="dev-features grid lg:grid-cols-2 gap-8">
            ...
            <div className="dev-cta mt-12 text-center">
      ...
      <footer className="footer border-t border-orange-500/20 py-12 bg-gradient-to-t from-orange-500/5 to-transparent">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="footer-text text-gray-300 mb-6 font-light leading-relaxed">
          ...
          <div className="footer-links flex items-center justify-center space-x-6 text-sm text-gray-400 font-light">
